...
Log into your personal GitHub account and go to https://github.com/hcrawford-tutorials/import-project .

Click on the green `Code` button and choose the `Codespaces` tab. Click on the green `Create codespace on main` button:
...
- Add and commit: Use the `--allow-empty` flag to allow an empty commit, or create a temp file in the project. At this point, the Codespace will notify you that you don't have push access to the original repo.
...
__You do not need to pay for anything or provide a payment method to work with this tutorial.__
