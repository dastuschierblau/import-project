...
The following challenges are available if you've finished the main lab and are looking for still more practice using Python imports. These are self-research driven questions on topics that were not covered in the main tutorial. Try them out in your Animal Classification lab code!
...
**Experiment:**
1. Create two modules that import from each other
